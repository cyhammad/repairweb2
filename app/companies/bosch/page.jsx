        ...
        >
          ...
          <div>
            ...
            <p className="py-6 text-lg font-raleway">
              Quick Appliances Repairs is a Bosch Service Centre in Dubai and
              Abu Dhabi. Trust our well-trained technicians to deliver
              professional & reliable Bosch repairs ensuring your appliances are
              in capable hands.Bosch Dishwasher Repair, Dryer,Washing
              Machine,Microwave and Refrigerator Repair.All Bosch Reparing
              Services.
            </p>
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div>
            <h1 className="text-4xl font-bold max-w-xl">
              Welcome To Quick Appliances Repair Bosch Service Center
            </h1>
            ...
            <p className="py-6 max-w-xl">
              Bosch Service Center Dubai is dedicated to providing high-quality
              service and repairs of Bosch kitchen appliances. We provide repair
              services for all kinds of Bosch kitchen appliances, including
              ...
              With our reliable Bosch service center in Dubai, you can rest
              ...
              customer.Bosch appliance repair Bosch appliance service Bosch
              appliance technician Bosch appliance maintenance Bosch appliance
              fix Bosch refrigerator repair Bosch washer and dryer repair Bosch
              dishwasher repair Bosch oven and stove repair Bosch microwave
              repair repair Bosch freezer repair Bosch range hood repair Bosch
        ...
        <div className="hero-content flex-col lg:flex-row">
          <div>
            <h1 className="text-4xl font-bold">
              Bosch Service Center Abu DHabi
            </h1>
            <p className="py-6">
              We provide Bosch Service Center in Abu Dhabi.The best Bosch
          ...
          <div>
            <h1 className="text-4xl mt-2 font-bold">
              Bosch Service Center Dubai
            </h1>
            <p className="py-6">
              We provide Bosch Service Center in Dubai. The best Bosch Service
