    ...
    <div>
          ...
          <div className="hero-content text-center md:text-left text-white">
            <div>
              <h1 className="text-5xl font-bold font-raleway text-white leading-tight">
                ...
                Best Dishwasher Repair Company in Dubai and Abu Dhabi.
              </h1>
              <p className="py-6 text-lg font-raleway">
                We offer the best in Dubai and Abu Dhabi, Affordable,
                Professional LG Dishwasher Repair Dubai. We offer our
                services 24/7. We are experts for LG Dishwasher Repair
      ...
      <div className="hero min-h-screen bg-base-100">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <h1 className="text-3xl font-bold max-w-xl">
              ...
              best LG Dishwasher Repair Service.
            </h1>
            ...
            <h1 className="text-lg font-bold max-w-xl">
                ...
                LG Dishwasher repair. Our company is a quality
              ...
              machines, dishwashers, fridges, Dishwashers, and all other electrical
              ...
              to repair all models of LG Dishwashers, equipped with
      ...
      <div className=" w-full bg-black h-auto md:h-[500px] ">
        <div className="hero min-h-screen bg-[#fafafa]">
          <div className="hero-content  flex-col lg:flex-row-reverse">
            <img loading="lazy"              src="/images/dishwasher/2.png"
            ...
            <div>
              ...
              <p className="py-6 text-black">
                ...
                Dishwashers,dishwashers,Dishwashers,Fridges, cooking ranges,
          ...
          <div className="hero-content  flex-col lg:flex-row-reverse ">
            ...
            <div>
              ...
              <p className="py-12 text-md px-4 font-semibold text-white">
                ...
                of LG appliances, including LG Dishwashers, dishwashers,
                fridges, Dishwashers, and all other electrical home appliances."
              </p>
              <button
                className="btn btn-info-content bg-[#be123c] text-white hover:text-black hover:bg-white hover:scale-110 duration-200 shadow-md  "
                onClick={() => {
              ...
              <div className="card-body">
                ...
                <div className="sm:w-[200px] md:w-[400px] h-auto">
                  <p>
                    ...
                    the optimal performance of your Dishwasher. Our LG
                    Dishwasher Repair Service is your reliable partner for
                    all your LG Dishwasher repair needs. We understand
                    the importance of a fully functional Dishwasher in your
