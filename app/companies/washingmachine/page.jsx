          ...
          <div className="hero-content text-center md:text-left text-white">
            <div>
              <h1 className="text-4xl  font-raleway text-white leading-tight">
                ...
                <span>
                  Samsung Appliances Service Center a Best Washing Machine
              ...
              <p className="py-6 text-lg font-raleway">
                ...
                Professional Samsung Washing Machine Repair Dubai. We offer our
                services 24/7. We are experts for Samsung Washing Machine Repair
          ...
          <div className="hero-content  flex-col lg:flex-row-reverse ">
            ...
            <div>
              ...
              <p className="py-12 text-md px-4 font-semibold text-white">
                ...
                you covered! Samsung washing machines use less water, energy and
                detergent. As per the Samsung Company, they state, 'Samsung
                washing machines not only simplify your life, but they do so
          ...
          <div>
            ...
            <p className="py-6 max-w-xl">
              <h1 className="text-lg font-bold max-w-xl">
                ...
                Samsung washing machine repair. Our company is a quality
