  ...
  return (
    <div>
        ...
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className="md:mr-20">
            ...
            <p className="py-6">
              ...
              - Your Trusted Dryer Repair Service Provider! Is your dryer
              causing frustration by not drying your clothes effectively? Quick
              Appliances Repairs is here to provide you with top-notch dryer
              repair services. We specialize in repairing a wide range of
              popular dryer brands, including Samsung, Bosch, Siemens, and LG.
            </p>
            <CallButton dark />
          </div>
        </div>
      ...
      <div
        ...
        style={{ backgroundImage: "url('/images/dryer/2.jpeg')" }}
      >
        ...
        <div className="hero-content text-center text-base-100 bg-black bg-opacity-60 md:p-10">
          <div className="max-w-md md:max-w-3xl lg:max-w-5xl">
            <h1 className="mb-5 text-2xl md:text-3xl font-bold">
              Why Choose Quick Appliances Repairs for Your Dryer Repairs?
            </h1>
            <ul className="list-disc list-inside space-y-3">
              <li>
                ...
                dryer repairs. They are well-versed in the intricacies of
                Samsung, Bosch, Siemens, and LG models, enabling them to
                diagnose and fix any issue with precision and efficiency.
              </li>
              <li>
                Prompt and Reliable Service: We understand the inconvenience
                caused by a malfunctioning dryer. That's why we prioritize
                prompt and reliable service. Our technicians will arrive at your
                location on time, equipped with the necessary tools and
                expertise to diagnose and resolve the problem quickly, ensuring
                your dryer gets back to efficiently drying your clothes.
              </li>
              <li>
                ...
                Siemens, or LG dryer. Our skilled technicians are trained to
                deliver meticulous repairs that address the root cause of the
                issue, ensuring your dryer operates flawlessly.
              </li>
              <li>
                Transparent Pricing: We offer competitive and transparent
                pricing for our dryer repair services. We provide upfront
                quotes, so you know exactly what to expect before we begin any
              ...
              <li>
                ...
                dryer repair experience hassle-free.
              </li>
              <li>
                Warranty: We stand behind our workmanship and the parts we use.
                That's why we offer a warranty on all our dryer repairs. If you
      ...
      <div className="hero min-h-screen bg-base-100">
        <div className="hero-content text-center">
          <div className="max-w-lg">
            ...
            <p className="py-6">
              Don't let a malfunctioning dryer dampen your laundry routine.
              Trust Quick Appliances Repairs to restore your Samsung, Bosch,
              Siemens, or LG dryer to optimal working condition. Schedule an
              ...
              and reliable dryer repair services that exceed your expectations.
              We are your trusted partner for all your appliance repair needs!
            </p>
